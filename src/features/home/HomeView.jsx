      ...
      >
        <div className="floating-animation">
          <img 
            ...
            src="https://images.unsplash.com/photo-1591169556548-21fee665ffae" 
          />
        </div>
        ...
        <p className="text-sm md:text-lg text-gray-600 max-w-2xl mx-auto px-4">
          Junte-se à missão de proteger Canaã dos Carajás! Complete desafios, aprenda sobre prevenção e torne-se um herói da saúde.
        </p>
      </motion.div>
